...
# Parse input to determine if imageb  source is a file, folder, video, or USB camera
...
while True:
    ...
    for classname, count in class_counts.items():
        cv2.putText(frame, f'{classname}: {count}', (10, y_offset), cv2.FONT_HERSHEY_SIMPLEX, .7, (0,255,255), 2) #Display detection results: FPS and per-class counts
        y_offset += 20
    #csv logging
